...
export default function PlayerList({ data }) {
  return (
    <ul className="max-h-[400px] md:max-h-[550px] overflow-y-scroll sm:text-xl md:text-2xl flex flex-col items-center gap-2 w-[100vw] p-6 sm:p-8 lg:p-0 lg:w-[800px]">
      {data.map((item, index) => (
        <li
          key={item._id}
